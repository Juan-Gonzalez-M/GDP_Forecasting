...
GENERATE_COMPREHENSIVE_REPORTS <- TRUE  # Whether to generate comprehensive multi-page reports

#' Create required directories if they don't exist
create_directories <- function() {
  # Define ALL needed directories, including subdirectories
  dirs <- c(
    OUTPUT_DIR, 
    FIGURES_DIR, 
    MODELS_DIR, 
    ...
    file.path(OUTPUT_DIR, "reports", "figures"),
    file.path(OUTPUT_DIR, "comprehensive_reports"),
    file.path(OUTPUT_DIR, "comprehensive_reports", "figures")
  )
